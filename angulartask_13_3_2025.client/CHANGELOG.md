...
- Create Angular project with ng: `ng new angulartask_13_3_2025.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angulartask_13_3_2025.client.esproj`).
